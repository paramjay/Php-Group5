      ...
      <form class="card card-body fs-6" action="utils/create_invoice.php" method="post">
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="fullName" value="<?php echo $user_info['user_name']; ?>"
              placeholder="Enter your full name" required readonly>
          </div>
          <div class="col-md-6 mb-3">
            <label for="email" class="form-label">Email address</label>
            <input type="email" class="form-control" id="email" value="<?php echo $user_info['user_email']; ?>"
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="address" value="<?php echo $user_info['user_address']; ?>"
              placeholder="1234 Main St" required readonly>
          </div>
          <div class="col-md-6 mb-3">
            <label for="Country" class="form-label">Country</label>
            <input type="text" class="form-control" id="Country" value="<?php echo $user_info['user_country']; ?>"
              required readonly>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="zip" value="<?php echo $user_info['user_postal_code']; ?>"
              required readonly>
          </div>
        </div>
        <div class="row">
