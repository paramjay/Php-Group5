...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true"
  ...
  <section>
    <button type="button" class="btn btn-warning" style="margin-left: 80px;"
      onclick="window.location.href='updateUserDetails.php'">Add New User Details</button>
  </section>
          ...
          <?php for ($i = 0; $i < count($users); $i++) { ?>
            <tr>
              ...
              <td><a class="btn btn-outline-primary"
                  href="updateUserDetails.php?id=<?php echo $users[$i]['user_id'] ?>">Edit</a>
                <button class="btn btn-outline-danger"
                  onclick="deleteUser('<?php echo $users[$i]['user_id'] ?>')">Delete</a>
              </td>
            </tr>
          <?php } ?>
