                ...
                <div class="row" id="filter-list">
                    <form class="card card-body fs-6">
                        <div class="form-group">
                            ...
                            <div class="form-check ">
                                <input class="form-check-input" name="type" type="checkbox" value="Electric"
                                    id="Electric">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" name="body_type" type="checkbox" value="Hatchback"
                                    id="Hatchback">
                                <label class="form-check-label" for="Hatchback">Hatchback</label>
                            </div>

                            <div class="form-check">
                                <input class="form-check-input" name="body_type" type="checkbox" value="Sedan"
                                    id="Sedan">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" name="body_type" type="checkbox" value="Pickup Truck"
                                    id="Pickup_Truck">
