...
<html>
  <head>
    <title>Vikram-Home</title>
    <meta charset="utf-8">
    <link rel="icon" href="images/logo-black.png" type="image/x-icon">
  ...
  <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
      ...
      <nav id="header-nav" class="navbar navbar-expand-lg px-3">
        <div class="container-fluid">
          <a class="navbar-brand " href="index.php">
            <img src="images/header-logo-color.png" id="car-logo">
            <p class="text-center text-black">Vikram</p>
          </a>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 pb-3">
            <div class="icon-box d-flex">
              ...
              <div class="icon-box-content">
                <h3 class="card-title text-uppercase text-dark">Sell/Buy</h3>
          ...
          <div class="col-lg-3 col-md-6 pb-3">
            <div class="icon-box d-flex">
              ...
              <div class="icon-box-content">
                <h3 class="card-title text-uppercase text-dark">Great offers</h3>
    ...
    <section id="car-products" class="product-store position-relative  no-padding-top">
      <div class="container">
        <div class="row">
          <div class="display-header d-flex justify-content-between pb-3">
            <h2 class="display-7 text-dark text-uppercase">Latest Cars</h2>
            <div class="btn-right">
      ...
      <div class="row d-flex flex-wrap align-items-center">
        <div class="col-md-6 col-sm-12">
          <div class="text-content offset-4 padding-medium">
            ...
            <h2 class="display-2 pb-5 text-uppercase text-light">Summer sale</h2>
          ...
          <div class="post-grid d-flex flex-wrap justify-content-between">
            <div class="col-lg-4 col-sm-12">
              ...
              <div class="card-body text-uppercase">
                <div class="card-meta text-muted">
                  ...
                  <span class="meta-category">- Luxury</span>
                </div>
                <h3 class="card-title">
                  <a href="#">Get some cool cars in 2024</a>
                </h3>
              </div>
            </div>
            <div class="col-lg-4 col-sm-12">
            ...
            <div class="col-lg-4 col-sm-12">
              ...
              <div class="card-body text-uppercase">
                <div class="card-meta text-muted">
                  <span class="meta-date">feb 22, 2024</span>
                  <span class="meta-category">- Cars</span>
                </div>
                <h3 class="card-title">
                  <a href="#">Top 10 Best Cars In The World</a>
                </h3>
              </div>
            </div>
          </div>
            ...
            <div class="row d-flex flex-wrap justify-content-between">
              <div class="col-lg-3 col-sm-6 pb-3">
                <div class="footer-menu">
                  ...
                  <p>Driving Innovation, Inspired by Tradition.</p>
                  <p>Fusing timeless elegance with cutting-edge performance for the ultimate driving experience.</p>
              ...
              <div class="col-lg-3 col-sm-6 pb-3">
                <div class="footer-menu contact-item">
                  ...
                  <p>Do you have any queries or suggestions? <a href="mailto:">group-5-PHP@Conestoga.com</a>
                  </p>
                  <p>If you need support? Just give us a call. <br/> <a href="">+1 111 222 333 44</a>
                  </p>
                </div>
              </div>
            </div>
